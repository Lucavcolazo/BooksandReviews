  ...
  if (loading) {
    return (
      <div className="bg-white rounded-lg border border-amber-200 p-6">
        <h2 className="text-xl font-semibold text-amber-900 mb-4">Mis Favoritos</h2>
        <div className="animate-pulse space-y-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex gap-4">
              <div className="w-16 h-24 bg-amber-200 rounded"></div>
    ...
    <>
      <div className="bg-white rounded-lg border border-amber-200 p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-amber-900">Mis Favoritos</h2>
        ...
        {!favoritesList || favoritesList.books.length === 0 ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold text-amber-900 mb-2">No tienes favoritos aún</h3>
            <p className="text-amber-700 mb-4">Explora libros y agrega tus favoritos para verlos aquí</p>
            <a
              href="/"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {favoritesList.books.map((book: BookListItem) => (
              <div key={book.bookId} className="bg-amber-50 rounded-lg border border-amber-200 p-4 hover:shadow-md transition-shadow">
                <div className="flex gap-3">
                  <div className="flex-shrink-0">
                    {book.bookThumbnail ? (
                      ...
                      <div className="w-16 h-24 bg-amber-200 rounded flex items-center justify-center border border-amber-300">
